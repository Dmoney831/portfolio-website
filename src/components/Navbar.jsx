    ...
    return (
            <Navbar className='main'  variant='dark' sticky='top' >
                <Nav className='main0 mt-1 px-5'>
                    ...
                    <ScrollLink to='profile' spy={true} smooth={true} offset={-50} duration={400} style={{ color: 'rgb(255, 249, 215)', textDecoration: 'none'}}>
                        <h5 className='nav-about px-2'>About</h5>
                    </ScrollLink>
                 
                    <ScrollLink to='projects' spy={true} smooth={true} offset={-50} duration={400} style={{ color: 'rgb(255, 249, 215)', textDecoration: 'none'}}>
